...
function alterarView($palavra)
{
    global $view_array, $ary_clear, $array;
    $id = array_search_all($palavra, $ary_clear);
    foreach ($id as $key) {
        $view_array[$key] = $array[$key];
    }
}
